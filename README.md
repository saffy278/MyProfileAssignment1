...
<h3>Overview</h3>
<p>The Project I am creating is called <b>"CyberBuddy"</b> and will support a person while they are online to reduce their risks of being hacked by malicious individuals and organisations. People are not very aware of how their clicking on weblinks can take them to dangerous places that look similar to legitimate websites, however, they may be going to a front for cybercriminals. The software will then grow in subsequent stages to allow evaluation and repair of Cyber Security leaks and threats in software as well. This application runs on any device however, my focus market will be Smart Phone platforms, e.g Android and iOS. The goal for this project is to create a functional cyber security application that tests the levels of security for various activities, applications and/or websites the user is engaged with. The application is aimed at keeping our personal data safe from being misused. I believe many people would want to use the Application to get a sort of score out of 10 on how good their personal security is for their common internet activities and of course protecting themselves online.</p>
<h3>Motivation</h3>
<p>The motivation comes from my personal interest in the cybersecurity aspect of IT as my Dad's company was hacked by a competitor and it cost him dearly as the attack was quite sophisticated over several months and all new business leads were diverted leading to a downturn in his business and he was forced to close down after 15 years and employing over one hundred people. Cyber Security is getting more sophisticated and there seems to be very little the Government and Police Force can actually do to track down cybercrime and protect people. It therefore, falls on others to build the software required to keep ahead of the cybercrime curve. The CyberBuddy software is an online assistant that reminds us to maintain good online behaviours that keep us safe.</p>

<p>I believe we all need to be more aware of the risks in using the Internet and so an application that evaluates your risks and gives a score on those risks would be very helpful and there will be a market for the product as long as it works seamlessly. The product must be easy for any user to implement and let them then plug any security vulnerabilities without hassle or at least they may need to change their behaviours to keep themselves safe with Cyber Buddy's guidance. The key is having remedies to counter the threats detected and make people's online browsing much more secure. </p>

<p>For around five years I have had a strong personal interest in ethical hacking and writing scripts that can help make my life easier online. The more I have invested in learning to master this area the more I realised that the Cyber Security arena is just massive and I have just scraped the tip of the iceberg. It is sort of exciting to know that you could never learn everything as every time someone builds a piece of software that there are people finding vulnerabilities to exploit. So the task of protecting systems will never go away. I think a career in cybersecurity will not disappear any time soon that is for sure.</p>
...
<p>
The first focus of this application will be aimed at how to reduce basic threats and risks that you may face in your everyday Internet Surfing life. We will be able to highlight security risks such as where you may be entering passwords and jumping to unsafe URLs to ensure the websites are actually legitimate and you are not being tricked. People too easily just click on email and weblinks and do not carefully watch where they may be taken. My software could start out by at least watching over this and letting people know if they are going to an odd looking website that may be risky. E.g. CyberBuddy will warn you about problems like clicking on a simple YouTube link that takes you somewhere potentially dangerous and flag this straight away before you get yourself into trouble.</p>

<p>The features of this app can be endless however, its main focus will be based around security online and keeping its users safe. This application will try to appeal to people in the market with minimal computer security expertise which is most people online. I thought about creating a Website for marketing purposes with an introductory video and short one minute Security Test that a person can take to assess their computer safety. For each score, the CyberBuddy Website will explain how you are vulnerable and how the CyberBuddy Software can support you improve your safety online. CyberBuddy could also provide training and other support to hopefully build a community. People need to invest more time into keeping themselves safe however, most people "don't know what they don't know", so step one is to get this message across to build credibility for the product.</p>

<h3>Skills Required</h3>
<p>Some of the skills I will need to build for this project involve programming in a variety of common languages used on the Internet and in common software like Javascript, Java, C++ & HTML. The skills in cybersecurity will take a long time to obtain and I probably need to do further certification after my Bachelor course in specific cybersecurity areas. I would also like to work in a cybersecurity development firm for several years to gain experience and build some networks.</p>


<h3>Tools and Technologies</h3>
<p>The hardware I will need includes several mobile devices for real-world testing as well as a reasonably powerful PC and MAC. The software is readily available for free or for a small charge and will depend on what the final product is written in. E.g. I can use Eclipse for Java or Visual Studio for C++ development. It is likely that the software will need to be able to interrupt the user at the time they do something dangerous and I am not aware yet of what this software is however, I am sure it exists as I have seen similar software step in over the top of existing applications. </p>
